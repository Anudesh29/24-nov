...
public class CostDailyConsp extends AbstractComponent {

	public CostDailyConsp(WebDriver driver) 
	{
		super(driver);
	...
	public void HeaderCheck(ExtentReports reportheader) {
		...
		public void CostDailyConspExport(ExtentReports report2) throws SQLException, FileNotFoundException, IOException, InterruptedException	{	
			//click on report logo
			
			driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[1]/div")).click();
			
			// click on CostDailyConspExport
			
			driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[2]/div/div/div[4]/div/div/div[34]/div/a/a/span[2]")).click();
			...
			logger=report2.createTest("Check Export Function->Cost Daily Consp Data Export ");
			logger.info("Cost Daily Consp Export function Test");
			...
			String downloadedFileName = "Cost Daily Consp Data Report.xlsx";
			boolean isFileDownloaded = isFileDownloaded(downloadedFileName);


			if (isFileDownloaded) {
				System.out.println("File downloaded successfully.");
				logger.log(Status.PASS,"Cost Daily Consp Data Export function file is downloaded successfully");
				// You can add further processing here if needed
			} else {
				System.out.println("File download failed.");
				logger.log(Status.FAIL,"Error!  Cost Daily Consp Data Export function file is not downloaded successfully");
			}
