...
public class DivisionDailyConsumption extends AbstractComponent {

	public DivisionDailyConsumption(WebDriver driver) 
	{
		super(driver);
	...
	public void HeaderCheck(ExtentReports reportheader) {
		...
		public void DivisionDailyConsumptionExport(ExtentReports report2) throws SQLException, FileNotFoundException, IOException, InterruptedException	{	
			//click on report logo
			
			driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[1]/div")).click();
			
			// click on DivisionDailyConsumptionExport
			
			driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[2]/div/div/div[4]/div/div/div[29]/div/a/a/span[2]")).click();
			...
			logger=report2.createTest("Check Export Function->Division Daily Consumption Data Export ");
			logger.info("Division Daily Consumption Export function Test");
			...
			String downloadedFileName = "Division Daily Consumption Data Report.xlsx";
			boolean isFileDownloaded = isFileDownloaded(downloadedFileName);


			if (isFileDownloaded) {
				System.out.println("File downloaded successfully.");
				logger.log(Status.PASS,"Division Daily Consumption Data Export function file is downloaded successfully");
				// You can add further processing here if needed
			} else {
				System.out.println("File download failed.");
				logger.log(Status.FAIL,"Error! Division Daily Consumption Data Export function file is not downloaded successfully");
			}
