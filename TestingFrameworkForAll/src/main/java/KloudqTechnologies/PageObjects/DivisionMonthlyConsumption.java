...
public class DivisionMonthlyConsumption extends AbstractComponent {

	public DivisionMonthlyConsumption(WebDriver driver) 
	{
		super(driver);
	...
	public void HeaderCheck(ExtentReports reportheader) {
		...
		public void DivisionMonthlyConsumptionExport(ExtentReports report2) throws SQLException, FileNotFoundException, IOException, InterruptedException	{	
			//click on report logo
			
			driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[1]/div")).click();
			
			// click on DivisionMonthlyConsumptionExport
			
			driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[2]/div/div/div[4]/div/div/div[30]/div/a/a/span[2]")).click();
			...
			logger=report2.createTest("Check Export Function->Division Monthly Consumption Data Export ");
			logger.info("Division Monthly Consumption Export function Test");
			...
			String downloadedFileName = "Division Monthly Consumption Data Report.xlsx";
			boolean isFileDownloaded = isFileDownloaded(downloadedFileName);


			if (isFileDownloaded) {
				System.out.println("File downloaded successfully.");
				logger.log(Status.PASS,"Division Monthly Consumption Data Export function file is downloaded successfully");
				// You can add further processing here if needed
			} else {
				System.out.println("File download failed.");
				logger.log(Status.FAIL,"Error! Division Monthly Consumption Data Export function file is not downloaded successfully");
			}
