...
public class EquipmentDailykwh extends AbstractComponent {

	public EquipmentDailykwh(WebDriver driver) 
	{
		super(driver);
	...
	public void HeaderCheck(ExtentReports reportheader) {
		...
		public void EqipmentDailykwhExport(ExtentReports report1) throws SQLException, FileNotFoundException, IOException, InterruptedException	{	
			//click on report logo
			
			driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[1]/div")).click();
			
			// click on EquipmentDailykwhreport
			
			driver.findElement(By.xpath("//*[@id=\"#kt_header_menu\"]/div[6]/div/div[2]/div/div/div[4]/div/div/div[26]/div/a/a/span[2]")).click();
			...
			logger=report1.createTest("Check Export Function->Eqipment Daily kwh Data Export ");
			logger.info("Eqipment Daily kwh Data Export function Test");
			...
			String downloadedFileName = "Eqipment Daily kwh Data Report.xlsx";
			boolean isFileDownloaded = isFileDownloaded(downloadedFileName);


			if (isFileDownloaded) {
				System.out.println("File downloaded successfully.");
				logger.log(Status.PASS,"Eqipment Daily kwh Data Export function file is downloaded successfully");
				// You can add further processing here if needed
			} else {
				System.out.println("File download failed.");
				logger.log(Status.FAIL,"Error! Eqipment Daily kwh Data Export function file is not downloaded successfully");
			}
